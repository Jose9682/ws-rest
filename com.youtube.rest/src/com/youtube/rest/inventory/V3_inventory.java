...
public class V3_inventory {
	 ...
	 * 
	 * Note: This is apart of the Jersey version 1 but I'm not su0re if
	...
	public Response addPcParts2(String incomingData) throws Exception {
		...
		try {
			 ...
			 * exist.
			 */
			int http_code = dao.insertIntoPC_PARTS(partsData.optString("MATRICULA"), 
														partsData.optString("NOMBRE"), 
														partsData.optString("APP"), 
														partsData.optString("APM"), 
														partsData.optString("EDAD"),
														partsData.optString("SEXO"),
														partsData.optString("FECHA_REGISTRO"),
														partsData.optString("USUARIO"));
